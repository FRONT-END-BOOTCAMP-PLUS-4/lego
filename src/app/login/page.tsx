        ...
        <div className="w-[448px] h-[660px] flex flex-col justify-center">
          <div className="h-[380px]">
            <div className="h-[200px] flex flex-col justify-center items-center">
              <img src="/assets/image/Logo.svg" className="w-[82px] h-[82px]"/>
            ...
            <div className="h-[180px] mt-[24px] flex flex-col items-center justify-center">
              <div className="  mb-[24px]">
                <button className="flex items-center justify-center w-[345px] h-[54px] border-2 border-solid mb-[8px] py-[15px] cursor-pointer rounded-md">
                  <img className="w-[24px] h-[24px] mr-[8px]" src="/assets/image/Github.svg"/>
                ...
                <button className="flex items-center justify-center w-[345px] h-[54px] border-2 border-solid py-[15px] cursor-pointer rounded-md">
                  <img className="w-[24px] h-[24px] mr-[8px]" src="/assets/image/Google.svg"/>
